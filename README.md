...
| Aman                                                        | Sangita                                                        | James                                                 |
| ----------------------------------------------------------- | -------------------------------------------------------------- | ----------------------------------------------------- |
| <ul><li>[X] `Owner` - for friend list                       | <ul><li>[ ] `Owner` - for login and search                     | <ul><li>[ ] `Owner` - for profile page                |
| <ul><li>[X] `Friendship` - for friend list                  | <ul><li>[ ] `Walk` - for scheduling bar and post               | <ul><li>[ ] `Owns_Dog` - for profile page             |
